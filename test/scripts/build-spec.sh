...
~/projects/polkadot-runtime-template/generic-template/target/release/generic-template-node build-spec --parachain-id 2003 --raw > specs/template-container-2003.json
../target/release/tanssi-node build-spec --chain dancebox-local --parachain-id 1000 --add-container-chain specs/template-container-2002.json --add-container-chain specs/template-container-2000.json --add-container-chain specs/template-container-2003.json --invulnerable "Collator1000-01" --invulnerable "Collator1000-02" --invulnerable "Collator2000-01" --invulnerable "Collator2000-02" --invulnerable "Collator2002-01" --invulnerable "Collator2002-02"  --invulnerable "Collator2003-01" --invulnerable "Collator2003-02" > specs/tanssi-1000.json
